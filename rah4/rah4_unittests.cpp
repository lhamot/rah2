...
{
    {
        test_case("counted_iterator", "sample", "");
        /// [counted_iterator]
...
int main()
{
    ...
    // Range factories
    testSuite.addTest("ranges::empty_view", test_empty_view);
    testSuite.addTest("ranges::single_view", test_single_view);
    testSuite.addTest("ranges::iota_view", test_iota_view);
    testSuite.addTest("ranges::basic_istream_view", test_istream_view);
    testSuite.addTest("ranges::repeat_view", test_repeat_view);
    // testSuite.addTest("ranges::cartesian_product_view", test_cartesian_product_view);

    // Range Adaptors
    testSuite.addTest("views::counted", test_views_counted);
    testSuite.addTest("ranges::owning_view", test_owning_view);
    testSuite.addTest("views::all", test_all_view);
    testSuite.addTest("ranges::filter_view", test_filter_view);
    testSuite.addTest("ranges::take_view", test_take_view);
    testSuite.addTest("ranges::drop_view", test_drop_view);
    testSuite.addTest("ranges::drop_while_view", test_drop_while_view);
    testSuite.addTest("ranges::join_view", test_join_view);
    testSuite.addTest("ranges::split_view", test_split_view);
    testSuite.addTest("views::counted", test_counted_view);
    testSuite.addTest("ranges::enumerate_view", test_enumerate_view);
    testSuite.addTest("ranges::elements_view", test_elements_view);
    testSuite.addTest("ranges::zip_view", test_zip_view);
    testSuite.addTest("ranges::adjacent_view", test_adjacent_view);
    testSuite.addTest("ranges::common_view", test_common_view);
    testSuite.addTest("ranges::reverse_view", test_reverse_view);
    testSuite.addTest("ranges::zip_transform_view", test_transform_view);
    testSuite.addTest("ranges::adjacent_transform_view", test_adjacent_transform);
    testSuite.addTest("ranges::slide_view", test_slide_view);
    testSuite.addTest("ranges::chunk_view", test_chunk_view);
    testSuite.addTest("ranges::stride_view", test_stride_view);
    testSuite.run();
