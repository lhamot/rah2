...
class test_view : public rah2::view_interface<test_view<Sent, Cat, SizedRange>>
{
    int start_ = 0;
    int stop_ = 0;
    int step_ = 1;
...
public:
    ...
    public:
        ...
        template <
            typename C = Cat,
            std::enable_if_t<rah2::derived_from<C, std::bidirectional_iterator_tag>>* = nullptr>
        iterator& operator--()
        {
            val_ -= step_;
            return *this;
        ...
        template <typename C = Cat, std::enable_if_t<rah2::derived_from<C, std::forward_iterator_tag>>* = nullptr>
        friend constexpr bool operator==(iterator const& it1, iterator const& it2)
        {
            return it1.val_ == it2.val_;
        }
        friend constexpr bool operator==(rah2::default_sentinel const&, iterator const&)
        {
            return false;
        }
        friend constexpr bool operator==(iterator const&, rah2::default_sentinel const&)
        {
            return false;
        }
        template <
...
class test_view_adapter : public rah2::view_interface<test_view<Sent, Cat, SizedRange>>
{
    Range base_;
    using base_iterator = rah2::iterator_t<Range>;
    using base_sentinel = rah2::sentinel_t<Range>;

public:
    class iterator : public rah2::iterator_facade<iterator, rah2::sentinel_iterator, int&, Cat>
    {
        base_iterator iter_;
    ...
    auto begin()
    {
        return iterator(rah2::begin(base_));
    }
    template <CommonOrSent S = Sent, std::enable_if_t<S == Sentinel>* = nullptr>
    auto end()
    {
    ...
    auto end()
    {
        return iterator(rah2::end(base_));
    }
    template <
        typename C = Cat,
        std::enable_if_t<RAH2_NAMESPACE::is_same_v<C, rah2::contiguous_iterator_tag>>* = nullptr>
...
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<OutputCommonView>>, "Should be input");
static_assert(not rah2::input_range<OutputCommonView>, "Should be input");
static_assert(rah2::output_range<OutputCommonView, int>, "Should be output");
static_assert(not rah2::input_or_output_iterator<OutputCommonView>, "Should be input");
static_assert(not rah2::forward_range<OutputCommonView>, "Should be Forward");
static_assert(not rah2::bidirectional_range<OutputCommonView>, "Should not be bidirectional");
static_assert(not rah2::random_access_range<OutputCommonView>, "Should not be random");
static_assert(not rah2::contiguous_range<OutputCommonView>, "Should not be contiguous");

// input
using InputCommonView = test_view<Common, std::input_iterator_tag, false>;
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<InputCommonView>>, "Should be input");
static_assert(rah2::input_range<InputCommonView>, "Should be input");
static_assert(not rah2::output_range<InputCommonView, int>, "Should not be output");
static_assert(not rah2::forward_range<InputCommonView>, "Should be Forward");
static_assert(not rah2::bidirectional_range<InputCommonView>, "Should not be bidirectional");
static_assert(not rah2::random_access_range<InputCommonView>, "Should not be random");
static_assert(not rah2::contiguous_range<InputCommonView>, "Should not be contiguous");

// Forward
using ForwardCommonView = test_view<Common, std::forward_iterator_tag, false>;
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<ForwardCommonView>>, "Should be input");
static_assert(rah2::input_range<ForwardCommonView>, "Should be input");
static_assert(not rah2::output_range<ForwardCommonView, int>, "Should not be output");
static_assert(rah2::forward_range<ForwardCommonView>, "Should be Forward");
static_assert(!rah2::bidirectional_range<ForwardCommonView>, "Should not be bidirectional");
static_assert(!rah2::random_access_range<ForwardCommonView>, "Should not be random");
static_assert(not rah2::contiguous_range<ForwardCommonView>, "Should not be contiguous");

// bidirectional
using BidirCommonView = test_view<Common, std::bidirectional_iterator_tag, false>;
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<BidirCommonView>>, "Should be input");
static_assert(rah2::input_range<BidirCommonView>, "Should be input");
static_assert(not rah2::output_range<BidirCommonView, int>, "Should not be outnput");
static_assert(rah2::forward_range<BidirCommonView>, "Should be Forward");
STATIC_ASSERT((rah2::bidirectional_range_impl<BidirCommonView, true>::value));
static_assert(!rah2::random_access_range<BidirCommonView>, "Should not be random");
static_assert(not rah2::contiguous_range<BidirCommonView>, "Should not be contiguous");

// random access
using RandomCommonView = test_view<Common, std::random_access_iterator_tag, true>;
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<RandomCommonView>>, "Should be input");
static_assert(rah2::input_range<RandomCommonView>, "Should be input");
static_assert(not rah2::output_range<RandomCommonView, int>, "Should not be output");
static_assert(rah2::forward_range<RandomCommonView>, "Should be Forward");
using It = rah2::iterator_t<RandomCommonView>;
using cat = rah2::range_iter_categ_t<RandomCommonView>;
static_assert(rah2::forward_iterator<It>, "");
static_assert(RAH2_NAMESPACE::is_same_v<decltype(--std::declval<It>()), It&>, "");
STATIC_ASSERT((rah2::bidirectional_range_impl<RandomCommonView, true>::value));
static_assert(rah2::bidirectional_range<RandomCommonView>, "Should be bidirectional");
using RandomCommonViewIter = RAH2_NAMESPACE::iterator_t<RandomCommonView>;
STATIC_ASSERT((rah2::random_access_range_impl<RandomCommonView, true>::value));
static_assert(not rah2::contiguous_range<RandomCommonView>, "Should not be contiguous");

// contiguous
using ContiCommonView = test_view<Common, rah2::contiguous_iterator_tag, true>;
static_assert(
    rah2::input_or_output_iterator<RAH2_NAMESPACE::iterator_t<ContiCommonView>>, "Should be input");
static_assert(rah2::input_range<ContiCommonView>, "Should be input");
static_assert(not rah2::output_range<ContiCommonView, int>, "Should not be output");
static_assert(rah2::forward_range<ContiCommonView>, "Should be Forward");
static_assert(rah2::bidirectional_range<ContiCommonView>, "Should be bidirectional");
static_assert(rah2::random_access_range<ContiCommonView>, "Should be random");
STATIC_ASSERT((rah2::contiguous_range_impl<ContiCommonView, true>::value));
static_assert(rah2::contiguous_range<ContiCommonView>, "Should be contiguous");

template <typename R>
constexpr bool is_input_common =
    rah2::input_range<R> && not rah2::forward_range<R> && rah2::common_range<R>;

template <typename R>
constexpr bool is_input_not_common =
    rah2::input_range<R> && not rah2::forward_range<R> && not rah2::common_range<R>;

template <typename R>
constexpr bool is_forward_common =
    rah2::forward_range<R> && not rah2::bidirectional_range<R> && rah2::common_range<R>;

template <typename R>
constexpr bool is_forward_not_common =
    rah2::forward_range<R> && not rah2::bidirectional_range<R> && not rah2::common_range<R>;

template <typename R>
constexpr bool is_bidirectional_common =
    rah2::bidirectional_range<R> && not rah2::random_access_range<R> && rah2::common_range<R>;

template <typename R>
constexpr bool is_bidirectional_not_common =
    rah2::bidirectional_range<R> && not rah2::random_access_range<R> && not rah2::common_range<R>;

template <typename R>
constexpr bool is_random_access_common =
    rah2::random_access_range<R> && not rah2::contiguous_range<R> && rah2::common_range<R>;

template <typename R>
constexpr bool is_random_access_not_common =
    rah2::random_access_range<R> && not rah2::contiguous_range<R> && not rah2::common_range<R>;

template <typename R>
constexpr bool is_contiguous_common = rah2::contiguous_range<R> && rah2::common_range<R>;

template <typename R>
constexpr bool is_contiguous_not_common = rah2::contiguous_range<R> && not rah2::common_range<R>;
...
{
    STATIC_ASSERT(rah2::input_range<R>);
    STATIC_ASSERT(not rah2::forward_range<R>);
};

template <typename R>
struct check_cat_impl<std::forward_iterator_tag, R>
{
    STATIC_ASSERT((rah2::forward_iterator_impl<rah2::iterator_t<R>, true>::value));
    STATIC_ASSERT(rah2::forward_range<R>);
...
{
    STATIC_ASSERT((rah2::bidirectional_range_impl<R, true>::value));
    STATIC_ASSERT(not rah2::random_access_range<R>);
};

template <typename R>
struct check_cat_impl<std::random_access_iterator_tag, R>
{
    STATIC_ASSERT((rah2::random_access_range_impl<R, true>::value));
    STATIC_ASSERT(not rah2::contiguous_range<R>);
};

template <typename R>
struct check_cat_impl<rah2::contiguous_iterator_tag, R>
{
    STATIC_ASSERT((rah2::contiguous_range_impl<R, true>::value));
};

template <typename BaseCat, typename MinCat, typename MaxCat, typename R>
void check_cat(R&&)
{
    using expected_cat = rah2::cap_iterator_tag<BaseCat, MinCat, MaxCat>;
...
struct test_one_range_setup_impl
{
    static void test()
    {
        ...
        AssertEqual<rah2::common_range<decltype(r1)>, t1.is_common>();
        AssertEqual<rah2::sized_range<decltype(r1)>, t1.is_sized>();
        AssertEqual<rah2::borrowed_range<decltype(r1)>, t1.is_borrowed>();
    }
};
...
void check_all_cat()
{
    test_one_range_setup<
        ...
        rah2::cap_iterator_tag<std::input_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    test_one_range_setup<
        Sentinel,
        std::forward_iterator_tag,
        rah2::cap_iterator_tag<std::forward_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    test_one_range_setup<
        Sentinel,
        std::bidirectional_iterator_tag,
        rah2::cap_iterator_tag<std::bidirectional_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    test_one_range_setup<
        Sentinel,
        std::random_access_iterator_tag,
        rah2::cap_iterator_tag<std::random_access_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    test_one_range_setup<
        Sentinel,
    ...
    test_one_range_setup<
        ...
        rah2::cap_iterator_tag<rah2::forward_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    test_one_range_setup<
        Common,
        rah2::bidirectional_iterator_tag,
        rah2::cap_iterator_tag<rah2::bidirectional_iterator_tag, MinCat, MaxCat>,
        false,
        MakeR>();
    ...
    test_one_range_setup<
        ...
        rah2::cap_iterator_tag<rah2::input_iterator_tag, MinCat, MaxCat>,
        true,
        MakeR>();
    test_one_range_setup<
        Sentinel,
...
struct PairEqualImpl
{
    ...
    auto operator()(P&& ab)
    {
        static_assert(
            RAH2_NAMESPACE::
                WeaklyEqualityComparableWith<decltype(std::get<0>(ab)), decltype(std::get<1>(ab))>,
...
void equalRange(R&& RANGE, I&& IL, char const* rangeName, char const* ILName)
{
    ...
    static_assert(
        RAH2_NAMESPACE::WeaklyEqualityComparableWith<
...
#endif
    if (rah2::all_of(rah2::views::zip(std::forward<R>(RANGE), std::forward<I>(IL)), PairEqual))
    {
#if defined(TEST_DISPLAY_ALL)
        std::cout << "OK" << std::endl;
#endif
...
template <typename R, typename = std::enable_if_t<rah2::range<R>>>
void toto(R&&)
{
}
...
{
    return toto(rah2::make_subrange(begin(il), end(il)));
}
