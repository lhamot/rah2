...
struct test_lexicographical_compare_
{
    ...
    void test()
    {
        // TODO : Test all ranges combinations ?
        {
            ...
            testSuite.test_case("iter");
            CHECK(not RAH2_NS::ranges::lexicographical_compare(r1.begin(), r1.end(), r1.begin(), r1.end()));
            CHECK(RAH2_NS::ranges::lexicographical_compare(r1.begin(), r1.end(), r2.begin(), r2.end()));
            CHECK(not RAH2_NS::ranges::lexicographical_compare(r2.begin(), r2.end(), r1.begin(), r1.end()));
            testSuite.test_case("empty");
            CHECK(RAH2_NS::ranges::lexicographical_compare(r3.begin(), r3.end(), r1.begin(), r1.end()));
            CHECK(not RAH2_NS::ranges::lexicographical_compare(r2.begin(), r2.end(), r3.begin(), r3.end()));
            CHECK(not RAH2_NS::ranges::lexicographical_compare(r3.begin(), r3.end(), r3.begin(), r3.end()));
        }
        {
            testSuite.test_case("range");
            ...
            CHECK(
                not RAH2_NS::ranges::lexicographical_compare(
    ...
    {
        {
            ...
            testSuite.test_case("empty");
            auto const iter3 = RAH2_NS::ranges::find_if_not(
                r2,
                [](auto c) {
                    return c != Coord{3, 0};
                });
...
struct test_find_last_if_
{
    ...
    void test()
    {
        ...
        CHECK((RAH2_NS::ranges::distance(iter.begin(), iter.end()) == 2));
        testSuite.test_case("empty");
        auto const iter4 = RAH2_NS::ranges::find_last_if(
            r2,
            [](Coord const& c) {
                return c == Coord{3, 0};
            });
...
struct test_find_last_if_not_
{
    ...
    void test()
    {
        ...
        CHECK((RAH2_NS::ranges::distance(iter.begin(), iter.end()) == 2));
        testSuite.test_case("empty");
        auto const iter4 = RAH2_NS::ranges::find_last_if_not(
            r2,
            [](Coord const& c) {
                return c != Coord{3, 0};
            });
