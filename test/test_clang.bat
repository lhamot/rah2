...
%~1++ -O%~4 -m%~3 -ftemplate-backtrace-limit=0 -o%~1_rah2_%~2_%~3_%~4.exe rah2_unittests.cpp test_algo.cpp test_views.cpp -std=c++%~2 -I../includes -Wall -Wno-c++17-extensions -Werror
%~1_rah2_%~2_%~3_%~4.exe
exit /b
