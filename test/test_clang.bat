...
%~1++ -O%~4 -m%~3 -ftemplate-backtrace-limit=0 -o%~1_rah2_%~2_%~3_%~5.exe test_range_factories.cpp rah2_unittests.cpp test_algo.cpp test_algo2.cpp test_range_adaptors3.cpp test_range_adaptors2.cpp test_range_adaptors.cpp test_concat_view.cpp test_set_difference_view.cpp test_zip_view.cpp test_zip_transform_view.cpp -DPERF_TEST -std=c++%~2 -I../includes -D%~5 -Wno-nonnull -Wall -Wextra -Werror
%~1_rah2_%~2_%~3_%~5.exe
exit /b
