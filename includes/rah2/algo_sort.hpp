    ...
    namespace ranges
    {
        ...
        namespace niebloids
        {
            struct nth_element
            {
                ...
                {
                    return (
                        *this)(RAH2_NS::ranges::begin(range), RAH2_STD::move(nth), RAH2_NS::ranges::end(range));
                }
                    ...
                    Proj proj = {}) const
                {
                    return (*this)(
                        RAH2_NS::ranges::begin(range),
                        RAH2_STD::move(nth), RAH2_NS::ranges::end(range), RAH2_STD::move(compare), RAH2_STD::move(proj));
                }
            };
        } // namespace niebloids
