    ...
    {                                                                                              \
                    ...
                    : public iterator_facade<common_iterator, void, iter_reference_t<base_iterator>, Cat>
                {
                    ...
                    struct equal
                    {
                        template <
                            ...
                            RAH2_STD::enable_if_t<equality_comparable<I>>* = nullptr>
                        auto operator()(base_iterator const& it1, base_iterator const& it2)
                        {
                            return it1 == it2;
                        }
        ...
        namespace views
        {
            ...
            class elements_view : public view_interface<elements_view<R, N>>
            {
                ...
                using reference =
                    decltype(RAH2_STD::get<N>(RAH2_STD::declval<range_reference_t<R>>()));
        ...
        namespace views
        {
            ...
            namespace details
            {
                ...
                template <class F, typename... Args, size_t... Is>
                auto transform_each_impl(
                    RAH2_STD::tuple<Args...>& t, F&& f, RAH2_STD::index_sequence<Is...>)
                {
                    return RAH2_STD::make_tuple(f(RAH2_STD::get<Is>(t))...);
                }
                ...
                struct equal_tuple
                {
                    ...
                    bool operator()(
                        RAH2_STD::tuple<Args...> const& a, RAH2_STD::tuple<Args2...> const& b) const
                    {
                ...
                public:
                    ...
                    auto operator*()
                    {
                        return details::apply(
                            view_->func_, *iter_, RAH2_STD::make_index_sequence<N>{});
                    }
                    friend bool operator==(iterator const& i, iterator const& i2)
                    {
            ...
            public:
                ...
                public:
                    ...
                    iterator(
                        base_iterator iter,
                        base_sentinel end,
                        base_diff_type stride,
                        base_diff_type missing)
        ...
        namespace views
        {
            ...
            class set_difference_view
                : public view_interface<set_difference_view<InputRng1, InputRng2>>
            {
